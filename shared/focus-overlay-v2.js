...
/**
 * @typedef {Object} FocusOverlayHandle
 * @property {HTMLElement} root
 * @property {{ top: HTMLElement; right: HTMLElement; bottom: HTMLElement; left: HTMLElement }} panels
 */
...
export function setOverlayVisible(handle, visible) {
  if (!handle?.root) return;
  handle.root.style.display = visible ? 'block' : 'none';
}

export function setPanelAlpha(handle, alpha) {
...
export function shouldSuspendFocusOverlayV2(doc) {
...
export function getViewport(doc) {
...
export function computeFocusRect(scopeEl, viewport) {
...
export function getExistingOverlayRoot(doc) {
...
export function createFocusOverlayV2(doc, options = {}) {
...
export function updateFocusOverlayV2(handle, focusRect, viewport) {
...
export function destroyFocusOverlayV2(handle) {
...
export { normalizeRect as _normalizeRect };

export function createFocusOverlayControllerV2(doc, options = {}) {
